...
package com.android.settings.bvalosek.ui;
...
import com.android.settings.bvalosek.*;
import com.android.settings.bvalosek.CpuStateMonitor.CpuState;
import com.android.settings.bvalosek.CpuStateMonitor.CpuStateMonitorException;
...
public class HomeActivity extends Activity
{
    ...
    private void findViews() {
        ...
        _uiKernelString = (TextView)findViewById(R.string.ui_kernel_string);
        _uiAdditionalStates = (TextView)findViewById(
                R.id.ui_additional_states);
        _uiHeaderAdditionalStates = (TextView)findViewById(
                R.string.ui_header_additional_states);
        _uiHeaderTotalStateTime = (TextView)findViewById(
                R.string.ui_header_total_state_time);
        _uiStatesWarning = (TextView)findViewById(R.string.ui_states_warning);
